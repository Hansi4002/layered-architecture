...
public class MaintenanceTM {
    ...
    public MaintenanceTM(String maintenanceId, String description, String staffId, String roomId, String status) {
    ...
    public int compareTo(MaintenanceTM maintenanceTM) {return maintenanceId.compareTo(maintenanceTM.maintenanceId);}
}
